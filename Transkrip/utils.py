...
# jadinya gapernu nunggu semua nilai diisi dulu baru dihitung IPS/IPK
def semua_nilai_lengkap(nilai_uts, nilai_uas, nilai_tes1, nilai_tes2) -> bool:
    ...
    FIX: Parameter sekarang eksplisit (bukan dict) agar lebih mudah dibaca
    dan menghindari KeyError jika key tidak ada.
